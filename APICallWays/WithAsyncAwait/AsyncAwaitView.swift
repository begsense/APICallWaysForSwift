...
final class AsyncAwaitView: UIViewController, DataUpdateProtocolAsyncAwait {
    
    private var viewModel: AsyncAwaitViewModel
...
extension AsyncAwaitView: UITableViewDataSource {
